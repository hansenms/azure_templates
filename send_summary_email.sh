...
data="{\"personalizations\": [{\"to\": ${to} }], \"from\": ${from},\"subject\": \"Gadgetron Cloud Summary ($h)\",\"content\": [{\"type\": \"text/html\", \"value\": \"<h1>Node Summary Statistics</h1>${node_stats}<img src='cid:ii_nodeplot'/>\"}],\"attachments\": [{\"content\": \"$img_base64\", \"type\": \"image/png\", \"filename\": \"node_plot.png\", \"disposition\":\"inline\",\"content_id\":\"ii_nodeplot\"}]}"
